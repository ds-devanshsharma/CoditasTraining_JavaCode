    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if(ValidationServlet.checkAlphabate(username)){
           try {
               ...
               preparedStatement.setString(3,req.getParameter("contact"));
               preparedStatement.setString(4,req.getParameter("city"));
               preparedStatement.setString(5,req.getParameter("education"));
               if(preparedStatement.executeUpdate()!=0) {
                   out.println("<h1><center>"+application.getAttribute("username")+" :: ");
                   out.println("Registration Successful !!</center><h1> <br>");
